...
import (
	...
	"github.com/Murat993/cli-chat/cmd/root/initcmd"
	"github.com/Murat993/cli-chat/cmd/root/md"
	"github.com/Murat993/cli-chat/cmd/root/token"
	login "github.com/Murat993/cli-chat/pkg/auth_v1"
	chat "github.com/Murat993/cli-chat/pkg/chat_v1"
...
var createUserCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		resp, err := client.Create(ctx, &emptypb.Empty{})
		if err != nil {
			log.Fatalf("failed to create user %v", err.Error())
		}

		log.Printf("user %s created with id:%v", usernameStr, resp.GetChatId())
	},
}
